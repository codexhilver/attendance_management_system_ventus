            ...
            {dates.map((date) => (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  >
                    <div className="font-semibold text-gray-900">{formatDateDisplay(date)}</div>
                ...
                <tbody>
                  {attendanceData.map((record: any) => (
                    <tr key={`${record.playerId}-${record.date}`} className="border-b hover:bg-gray-50">
                      ...
                      <td className="py-2 px-4">{formatTime(record.timeIn)}</td>
                      <td className="py-2 px-4">{formatTime(record.timeOut)}</td>
